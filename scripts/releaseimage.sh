...
function release-images()
{
    ...
    release-fs-partition tvservice $BOARD_TVSERVICEIMAGE_PARTITION_SIZE false
    release-fs-partition tvconfig $BOARD_TVCONFIGIMAGE_PARTITION_SIZE false
    release-fs-partition tvdatabase $BOARD_TVDATABASEIMAGE_PARTITION_SIZE false
